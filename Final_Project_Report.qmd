...
ggplot(plot_dat, aes(x = month, color = year, group = year)) +
  ...
  labs(
<<<<<<< HEAD:Final Project Report.qmd
    title = "Actual (solid) vs Regular (dashed) vs Historical (dotted) Predictions",
    x = "Month", y = "log(Mean Fire Size)", color = "Year"
=======
    title = "Log Scale of Actual (solid) vs Regular (dashed) vs Historical (dotted) Predictions",
    x = "Month",
    y = "Mean Fire Size",
    color = "Year"
>>>>>>> 19e4aa78020e903c07a4e4cc6c3ac689ac36eeb2:Final_Project_Report.qmd
  ) +
  theme_minimal() +
